     ...
     <div className='flex justify-center items-center mt-6'>
      ...
      <div className='max-w-3xl mx-auto bg-gray-300 border border-gray-800 p-6 rounded-lg mt-15'>
        <div className='max-w-2xl mx-auto'>
          <h1 className='text-center text-3xl text-blue-500 font-bold mb-6'>Update User</h1>
          ...
          <form onSubmit={handleSubmit} className='w-full border border-sky-700 p-6 rounded-md bg-white shadow-md'>
            ...
            <div className='flex'>
              <input
                className='bg-red-600 p-2 rounded-xl w-full cursor-pointer text-white hover:bg-red-500 transition duration-300'
                type="submit"
                value="Update User"
              />
            </div>
